...
sudo yum install gcc gcc-c++ autoconf automake libtool gdb bison flex openssl-devel tcl-devel pcre-devel hwloc-devel patch emacs libcap-devel perl-ExtUtils-MakeMaker doxygen graphviz libffi-devel python-devel python-virtualenv python-pip redhat-rpm-config 

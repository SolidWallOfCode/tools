...
ln -s ~amc/git/ats/lib/ts/.libs/libtsutil.so.7.0.0 ../lib
rm ../lib/libtsutil.so.7
ln -s ../lib/libtsutil.so.7.0.0 ../lib/libtsutil.so.7
rm ../lib/libtsutil.so
ln -s ../lib/libtsutil.so.7.0.0 ../lib/libtsutil.so

rm ../lib/libtsmgmt.so.[567].[012].*
ln -s ~amc/git/ats/mgmt/api/.libs/libtsmgmt.so.7.0.0 ../lib
rm ../lib/libtsmgmt.so.[567]
ln -s ../lib/libtsmgmt.so.7.0.0 ../lib/libtsmgmt.so.7
rm ../lib/libtsmgmt.so
ln -s ../lib/libtsmgmt.so.7.0.0 ../lib/libtsmgmt.so

rm ../lib/libtsconfig.la
ln -s ~amc/git/ats/lib/tsconfig/.libs/libtsconfig.la ../lib/libtsconfig.la
rm ../lib/libtsconfig.so.[567].[012].*
ln -s ~amc/git/ats/lib/tsconfig/.libs/libtsconfig.so.7.0.0 ../lib
rm ../lib/libtsconfig.so.[567]
ln -s ../lib/libtsconfig.so.7.0.0 ../lib/libtsconfig.so.7
rm ../lib/libtsconfig.so
ln -s ../lib/libtsconfig.so.7.0.0 ../lib/libtsconfig.so
...
ln -s ~amc/git/ats/lib/atscppapi/src/.libs/libatscppapi.so.7.0.0 ../lib
rm ../lib/libatscppapi.so.7
ln -s ../lib/libatscppapi.so.7.0.0 ../lib/libatscppapi.so.7
rm ../lib/libatscppapi.so
ln -s ../lib/libatscppapi.so.7.0.0 ../lib/libatscppapi.so
